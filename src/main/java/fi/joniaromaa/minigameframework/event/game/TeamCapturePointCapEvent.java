...
public class TeamCapturePointCapEvent extends GameTeamEvent implements Cancellable
{
    ...
    public TeamCapturePointCapEvent(AbstractMinigame<?, ?> minigame, AbstractMinigameTeam<?> team, List<AbstractMinigamePlayer<?>> players)
    {
    	super(minigame, team);
	...
	{
		return TeamCapturePointCapEvent.handlers;
	}
